...
Reads  researcher/legacy/valuation/<slug>_digest.json  (subject + engine output + advisory,
...
def main():
    ...
    d = json.load(open(os.path.join(ROOT, "researcher", "legacy", "valuation", f"{slug}_digest.json"),
                       encoding="utf-8-sig"))
    htmls = render(d)
