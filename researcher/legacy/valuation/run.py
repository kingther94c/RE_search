...
the HTML report.  Run:  python -m researcher.legacy.valuation.run

LEGACY (2026-07-18): the engine-v1 Spottiswoode trial, kept runnable as the
craft reference. All work is inside main() — importing this module is side-effect
free (it used to re-run the study and overwrite results.json on import).
"""
...
from researcher.legacy.valuation import dataset as D
from researcher.legacy.valuation.engine import Comp, Params, Subject, format_grid, value
